...
import hry.third.huobi.api.JsonUtil;
...
public class MessageProducer {
    ...
    public void toMinerCoinageByDay(Object message)  {  
    	try {  
    		amqpTemplate.convertAndSend("toMinerCoinageByDayKey", message);  
    	} catch (Exception e) {
    		e.printStackTrace();
    	}
    } 
    ...
    public void toCmUpdateGrade(Object message)  {  
    	try {  
    		amqpTemplate.convertAndSend("toCmUpdateGradeKey", message);  
    	} catch (Exception e) {
    		e.printStackTrace();
    	}
    } 
    ...
    public void toCmBuyAndcloseMinerUpdateGrade(Object message)  {  
    	try {  
    		amqpTemplate.convertAndSend("toCmBuyAndcloseMinerUpdateGradeKey", message);  
    	} catch (Exception e) {
    		e.printStackTrace();
    	}
    } 
    ...
    public void toCmProfit1Key(Object message)  {  
    	try {  
    		amqpTemplate.convertAndSend("toCmProfit1Key", message);  
    	} catch (Exception e) {
    		e.printStackTrace();
    	}
    } 
     ...
     * @param message
     */
    public void toCmProfit2Key(Object message)  {  
    	try {  
    		amqpTemplate.convertAndSend("toCmProfit2Key", message);  
    	} catch (Exception e) {
    		e.printStackTrace();
    	}
    } 
