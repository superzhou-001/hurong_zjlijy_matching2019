...
public class MessageCmAccount implements ChannelAwareMessageListener {
    ...
    private static final String NAME = "toCmSonAccount";

    @Resource
    private CmSonAccountService cmSonAccountService;

    @Override
    public void onMessage(Message message, Channel channel) {
        try {
            cmSonAccountService.accountaddQueue(new String(message.getBody()));
            //正常确认
