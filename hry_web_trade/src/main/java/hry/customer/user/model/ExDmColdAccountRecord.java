...
public class ExDmColdAccountRecord extends BaseModel {
	...
	public ExDmColdAccountRecord(Long id, Long accountId, Long customerId,
	...
	public String toString() {
		return "ExDmColdAccountRecord [id=" + id + ", accountId=" + accountId
