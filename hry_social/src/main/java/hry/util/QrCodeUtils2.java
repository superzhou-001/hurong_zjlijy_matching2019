...
public class QrCodeUtils2 {
    ...
    private static BufferedImage createImage(String content, URL logoPath,String fileName, boolean needCompress) throws Exception {
     ...
     * @throws Exception
     */
    public static String encode(String content, URL logoPath,  String fileName, boolean needCompress) throws Exception {
        BufferedImage image = QrCodeUtils2.createImage(content, logoPath,fileName, needCompress);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String qrcode = QrCodeUtils2.encode(text, a, "C:/Users/yujl/Pictures/Saved Pictures", s, true);
