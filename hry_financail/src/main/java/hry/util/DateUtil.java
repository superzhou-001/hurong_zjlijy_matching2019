...
public class DateUtil {
	...
	public static Map<Integer, Integer> getMonthAndDaysBetweenDate(
		...
		if (d1.getTime() < d2.getTime()) {
			...
			days = getDaysBetweenDate(
					getFormatDateTime(
							addMonthsToDate(
									hry.util.date.DateUtil.parseDate(date1, "yyyy-MM-dd"),
	...
	public static void main(String[] args){
		...
		Map<String, Date> periodDate2 = getPeriodDate2(new Date());
		Set<String> keySet = periodDate2.keySet();
		Iterator<String> iterator = keySet.iterator();
		while (iterator.hasNext()) {
			String next = iterator.next();
			Date date = periodDate2.get(next);
			System.out.println(next+"========="+ hry.util.date.DateUtil.dateToString(date));
		}
	 ...
	 * @return
	 */
	public static Integer getDaysBetweenTwoDate(Date date1, Date date2) {
		Date d1 = date1;
		Date d2 = date2;
		Calendar c1 = Calendar.getInstance();
