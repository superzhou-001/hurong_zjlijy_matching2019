 ...
 * @Date :          2019-04-03 11:06:50  
 */
@Table(name="app_financial_products")
public class AppFinancialProducts extends BaseModel implements Serializable {
	...
	@Column(name= "earlyRedemption")
	private Integer earlyRedemption;  //能否提前赎回  0否  1是
	
	@Column(name= "redemptionRate")
	private String redemptionRate;  //赎回费率
	
	@Column(name= "interestBearing")
	...
	@Column(name= "startingInterestTime")
	private Date startingInterestTime;  //开始计息时间
	
	@Column(name= "returnOfPrincipalTime")
	private Date returnOfPrincipalTime;  //返还本息时间
	
	@Column(name= "remarks")
	private String remarks;  //产品说明
	
	@Column(name= "canUseRedPackets")
	private Integer canUseRedPackets;  //能否使用红包
