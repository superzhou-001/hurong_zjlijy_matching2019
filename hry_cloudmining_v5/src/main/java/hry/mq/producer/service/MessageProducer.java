...
public class MessageProducer {
    ...
    public void toMinerCoinageByDay(Object message)  {  
    	try {  
    		amqpTemplate.convertAndSend("to2MinerCoinageByDayKey", message);
    	} catch (Exception e) {
    		e.printStackTrace();
    	}
    } 
    ...
    public void toCmUpdateGrade(Object message)  {  
    	try {  
    		amqpTemplate.convertAndSend("toCm2UpdateGradeKey", message);
    	} catch (Exception e) {
    		e.printStackTrace();
    	}
    } 
    ...
    public void toCmBuyAndcloseMinerUpdateGrade(Object message)  {  
    	try {  
    		amqpTemplate.convertAndSend("toCm2BuyAndcloseMinerUpdateGradeKey", message);
    	} catch (Exception e) {
    		e.printStackTrace();
    	}
    } 
    ...
    public void toCmProfit1Key(Object message)  {  
    	try {  
    		amqpTemplate.convertAndSend("toCm2Profit1Key", message);
    	} catch (Exception e) {
    		e.printStackTrace();
    	}
    } 
    ...
    public void toCmProfit2Key(Object message)  {  
    	try {  
    		amqpTemplate.convertAndSend("toCm2Profit2Key", message);
    	} catch (Exception e) {
    		e.printStackTrace();
    	}
    } 
