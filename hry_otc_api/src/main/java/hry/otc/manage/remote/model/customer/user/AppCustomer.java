 ...
 */
package hry.otc.manage.remote.model.customer.user;
...
public class AppCustomer extends BaseModel {
	...
	@Column(name= "curLoginDevice", columnDefinition = "varchar(255)  DEFAULT NULL COMMENT '当前登录设备信息'")
	private String curLoginDevice;

	@Column(name= "curLoginDeviceId", columnDefinition = "bigint(20)  DEFAULT NULL COMMENT '当前登录设备信息id'")
	private Long curLoginDeviceId;
	...
	public String getCurLoginDevice () {
		return curLoginDevice;
	}

	public void setCurLoginDevice (String curLoginDevice) {
		this.curLoginDevice = curLoginDevice;
	}

	public Long getCurLoginDeviceId () {
		return curLoginDeviceId;
	}

	public void setCurLoginDeviceId (Long curLoginDeviceId) {
		this.curLoginDeviceId = curLoginDeviceId;
	}

	@Override
	public String toString() {
		return "AppCustomer{" + "id=" + id + ", userName='" + userName + '\'' + ", passWord='" + passWord + '\'' + ", accountPassWord='" + accountPassWord + '\'' + ", salt='" + salt + '\'' + ", isLock=" + isLock + ", lockTime=" + lockTime + ", isChange=" + isChange + ", isDelete=" + isDelete + ", isReal=" + isReal + ", userCode='" + userCode + '\'' + ", integral=" + integral + ", type='" + type + '\'' + ", appPersonInfo=" + appPersonInfo + ", referralCode='" + referralCode + '\'' + ", hasEmail=" + hasEmail + ", googleKey='" + googleKey + '\'' + ", googleState=" + googleState + ", googleDate=" + googleDate + ", isProving=" + isProving + ", messIp='" + messIp + '\'' + ", passDate=" + passDate + ", phoneState=" + phoneState + ", openPhone=" + openPhone + ", states=" + states + ", commendCode='" + commendCode + '\'' + ", agentCommendCode='" + agentCommendCode + '\'' + ", safeLoginType=" + safeLoginType + ", safeTixianType=" + safeTixianType + ", safeTradeType=" + safeTradeType + ", isBlacklist=" + isBlacklist + ", isGag=" + isGag + ", gagDate=" + gagDate + ", gagTime=" + gagTime + ", isAdmin=" + isAdmin + ", uuid='" + uuid + '\'' + ", fishingCode='" + fishingCode + '\'' + ", curLoginDevice='" + curLoginDevice + '\'' + ", curLoginDeviceId=" + curLoginDeviceId + ", oneNumber=" + oneNumber + ", twoNumber=" + twoNumber + ", threeNumber=" + threeNumber + ", laterNumber=" + laterNumber + ", trueName='" + trueName + '\'' + ", surname='" + surname + '\'' + ", trustNum=" + trustNum + ", shieldNum=" + shieldNum + ", nickNameOtc='" + nickNameOtc + '\'' + ", commonLanguage='" + commonLanguage + '\'' + ", busNumber='" + busNumber + '\'' + ", isMarketTransactions=" + isMarketTransactions + '}';
	}
}
