 ...
 */
package hry.cm4.profitone.model;
 ...
 * @Date :          2019-11-21 10:04:25  
 */
@Table(name="cm4_profit_one")
public class Cm4ProfitOne extends BaseModel {
	...
	@Column(name= "type")
	private Integer type;  //收益类型 1.静态收益 
	
	@Column(name= "hierarchy")
	private Integer hierarchy;  //层级
	
	@Column(name= "profitCoinCode")
	private String profitCoinCode;  //计算收益币种
	
	@Column(name= "coinCodeRate")
	private String coinCodeRate;  //每个关联币种对应的价钱
	 ...
	 * <p>每个关联币种对应的价钱</p>
	 * @author:  yaozh
	 * @param:   @param coinCodeRate
	 * @return:  void 
	 * @Date :   2019-11-21 10:04:25   
	 */
	public void setCoinCodeRate(String coinCodeRate) {
		this.coinCodeRate = coinCodeRate;
	}
