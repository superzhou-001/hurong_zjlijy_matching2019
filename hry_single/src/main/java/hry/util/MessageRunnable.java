...
public class MessageRunnable implements Runnable {
    ...
    public MessageRunnable(String msgJson) {
        System.out.println("通知消息MQ信息====>>>" + msgJson);
        if (null != msgJson) {
            NoticeMessage noticeMessage = JSON.parseObject(msgJson, NoticeMessage.class);
            this.user = noticeMessage.getUser();
            this.templateKey = noticeMessage.getMsgkey();
            this.params = noticeMessage.getParamers();
        }
    }
