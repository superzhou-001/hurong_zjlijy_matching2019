...
import hry.social.transaction.dao.ExDmTransactionDao;
...
public class ExDmTransactionServiceImpl extends BaseServiceImpl<ExDmTransaction, Long> implements ExDmTransactionService {
	 ...
	 */
	@Override
	public ExDigitalmoneyAccountRedis getAccount4DB(Long customerId, String coinCode) {
		return ((ExDmTransactionDao)dao).getAccount4DB(customerId, coinCode);
	}
}
