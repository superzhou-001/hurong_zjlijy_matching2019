...
public class SocialMiningGatherRecord extends BaseModel {
    ...
    public String toString() {
        return "SocialMiningGatherRecord{" + "id=" + id + ", coinCode='" + coinCode + '\'' + ", rewardId=" + rewardId + ", gatherNum=" + gatherNum + ", gatherId=" + gatherId + ", gatherType=" + gatherType + ", gatherTime=" + gatherTime + ", created=" + created + ", customerId=" + customerId + ", name='" + name + '\'' + ", mobilePhone='" + mobilePhone + '\'' + ", surname='" + surname + '\'' + ", trueName='" + trueName + '\'' + ", nickName='" + nickName + '\'' + ", gatedName='" + gatedName + '\'' + ", states=" + states + '}';
    }
}
