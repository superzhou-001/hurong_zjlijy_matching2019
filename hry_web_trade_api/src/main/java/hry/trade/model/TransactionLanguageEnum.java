...
public enum TransactionLanguageEnum {
    TYPE1("entrusted_order", 1),
    ...
    TYPE21("chongbi", 21),  //充值
    TYPE22("tibi", 22), //确认提现
    TYPE23("chongbi", 23), //手动充值
    TYPE24("chongbi", 24),  //手动充值又撤销
    TYPE25("tibi", 25), //手动提现
    TYPE31("chongbi", 31),   //充币
    TYPE32("tibi", 32),    //人民币提现
    TYPE33("tibi", 33),   //提币审核成功
    TYPE34("tibi", 34),    //提币手续费审核成功
    TYPE35("tibi", 35),    //申请币提现
    TYPE36("tibi", 36), //申请币提现手续费
    TYPE37("tibi", 37),    //提币已驳回
    TYPE38("tibi", 38),  //人民币提现驳回

    TYPE40("佣金派发", 40), //佣金派发
    TYPE41("下级充币返佣", 41),   //下级充币返佣
    TYPE42("下级C2C充币返佣", 42),    //下级C2C充币返佣
    ...
    TYPE500("coin_reward_record", 500),
    TYPE503("coin_conversion", 503),
    TYPE504("friend_transfer", 504),
    TYPE505("friends_rewards", 505),
    TYPE506("wish_wall_record", 506),
    TYPE507("public_welfare_record", 507),
    TYPE508("mill_record", 508),
    TYPE509("vip_record", 509),
    TYPE510("purchase_goods_record", 510),
    TYPE511("vip_reward_record", 511),  //持币生息
    TYPE512("mill_reward_record", 512),  //矿机奖励
    TYPE513("shop_reward_record", 513),  //商城奖励
    TYPE514("adv_reward_record", 514),  //广告奖励
    TYPE515("interest_reward_record", 515)  //持币生息
    ;
    ...
    private TransactionLanguageEnum(String name, int index) {
        this.name = name;
        this.index = index;
    }

    public static String getName(int index) {
        for (TransactionLanguageEnum c : TransactionLanguageEnum.values()) {
            if (c.getIndex() == index) {
                return c.name;
            }
        }
