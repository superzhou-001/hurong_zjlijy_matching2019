...
public class UserAgentUtils {
    ...
    public static String toJsonStr(String userAgent) {
        ...
        map.put("浏览器组：", getBorderGroup(userAgent));
        map.put("浏览器名字：", getBorderName(userAgent));
        map.put("浏览器类型", getBorderType(userAgent));
        ...
        map.put("操作系统浏览器的渲染引擎:", getBorderRenderingEngine(userAgent));
        return map.toString();
    }

    public static String toJsonStr(HttpServletRequest request) {
        Map<String, String> map = new HashMap<>();
        map.put("浏览器组：", getBorderGroup(request));
        map.put("浏览器名字：", getBorderName(request));
        map.put("浏览器类型", getBorderType(request));
        ...
        map.put("操作系统浏览器的渲染引擎:", getBorderRenderingEngine(request));
        return map.toString();
    }
